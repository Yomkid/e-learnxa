...
<body>
    <div class="container success-page">
        ...
        <div class="success-content">
            ...
            <p>Your Registration Payment has been confirmed, below are the details and PCC to activate your account and
                start learning</p>

            <div class="col-md-6 col-sm-6">
                <div><span class="biller-info">Payment Confirmation Code (PCC):
                        <strong><?= $payment_confirmation_code ?></strong>.</div>
            </div>
            <div class="col-md-6 col-sm-6">
