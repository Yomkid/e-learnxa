...
<body>
    ...
    <!-- Hero Section -->
    <!-- <header class="hero" style="background: url('./assets/img/hero_image.png') no-repeat center center/cover;"> -->
    <!-- Hero Section -->
    <div class="hero">
                ...
                <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p class="lead">Online learning and teaching marketplace with 5K+ courses & 10M students. Taught
                            by experts to help you acquire new skills. Enroll with jus ₦1,000</p>
