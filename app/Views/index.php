...
<body>
    ...
    <main id="startLearning">
        ...
        <div class="container mt-0 mb-0">
            <div class="d-flex justify-content-between heading mt-4">
                <a class="navbar-brand nav-logo" href="#">Learn<span style="color: #007bff;">X</span>a</a>
                <h2 class="course-category">Virtual Classes [Apprentiship Courses]</h2>
            </div>
            <p>With these programs, you can subsribe to build valuable skills, earn career credentials, when you
                enroll for the virtual class.</p>

            <!-- Scrollable Course Section -->
            <div class="scrollable-section-container">
                <button class="scroll-btn left-scroll" id="left-scroll-btn">&#9664;</button>
            ...
            <a href="/virtual-courses"><button type="button" class="btn btn-outline-secondary btn-lg px-4">Explore &
                    Enroll</button></a>
        </div>
