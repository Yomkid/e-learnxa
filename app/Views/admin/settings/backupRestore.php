...
<?php include(APPPATH . 'Views/admin/include/sidebar.php'); ?>
    <main id="main" class="main p-0">
        ...
        <div class="container mt-2" id="mainContent">
            <div class="mb-3 font-weight-bold">Backup and Restore</div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Click below to create a new backup of the system.</p>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Upload a backup file to restore system data.</p>
                                        <form>
                                            <div class="form-group">
                                                <input type="file" class="form-control-file" id="backupFile">
                                            </div>
