    ...
    <main id="main" class="main p-0">
        ...
        <div class="container mt-2" id="mainContent">
            ...
            <ul class="nav nav-tabs" id="quizTabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="assign-quiz-tab" data-toggle="tab" href="#assign-quiz" role="tab"
            ...
            <div class="tab-content" id="questionTabsContent">
                ...
                <div class="tab-pane fade mt-2" id="assign-quiz" role="tabpanel" aria-labelledby="assign-quiz-tab">
                    <form action="<?= base_url('questionbank/exportQuestions') ?>" method="post">
                        <div class="form-group">
                            <label for="course_id">Select Course</label>
                            <select id="course_id" name="quiz_id" class="form-control">
                                <option value="">All Courses</option>
                                
                            </select>
                        </div>
                        <!-- A course can be search or filter and picked by category, title, date, topics and so on -->
                    </form>
                </div>
                <!-- Quiz Settings -->
                <div class="tab-pane fade mt-2" id="quiz-settings" role="tabpanel" aria-labelledby="quiz-settings-tab">
                    <div>Quiz Settings</div>
                    <!-- quiz settings frontend here with the selected quiz -->
                </div>
            </div>
    </main>
