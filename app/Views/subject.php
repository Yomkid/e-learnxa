...
<body>
    ...
    <div class="container-fluid mt-0">
        <div class="d-flex justify-content-between heading mt-4">
            ...
            <h2 class="course-category">Data Science Courses</h2>
        </div>
        <p>You can find all Data Science related courses here, explore and start learning</p>
