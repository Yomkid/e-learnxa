        ...
        <div class="row">
            ...
            <div class="col-lg-8 mt-3">
                ...
                <div class="d-flex justify-content-between navigation-buttons">
                    <button id="prev-button" type="button" class="btn btn-primary"
                        style="display: none;">Previous</button>
                    <button id="next-button" type="button" class="btn btn-primary" style="display: none;">Next
                        Module</button>
                </div>
    ...
    <script>
        ...
        $('.module-button').click(function () {
            ...
            $.ajax({
                ...
                error: function () {
                    $('#lesson-content').html(
                        '<p>An error occurred while fetching lesson data.</p>');
                }
            });
        ...
        function loadLesson(index) {
            if (lessons.length > 0) {
                ...
                $('#next-button').toggle(index < lessons.length - 1);
            }
        }
